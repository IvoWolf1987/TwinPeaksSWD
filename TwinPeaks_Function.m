...
[result1, frequencymap1, timepoints1, power1] = spectrogram(cxraw,window,round(SR*0.5),SR*10,SR); %obtain a matrix of amplitudes, the corresponding frequencies, timepoints and power for a sliding fft with 1 seconds window-size (using predefined window value, see above), window-overlapp of 0.5 seconds, and zero-padding for 0.1 Hz resolution (10*SR)
